            ...
            it?.let {
               // viewModel.ResValue(it)
                it.forEach{
                    ...
                    if (it.medIntrerection.equals("-") || it.medIntrerection.equals("----") || it.medIntrerection.equals("-----")){
                        binding.constraintLayout5.isVisible = false
                    }else{
                        binding.warningsTV.setText(it.medIntrerection)
                    }

                    if (it.missedDose.equals("-") || it.missedDose.equals("----") || it.missedDose.equals("-----")){
                        binding.doseLyout.isVisible = false
                    }else{
                        binding.missedDoseTV.setText(it.missedDose)
                    }
                    if (it.overdose.equals("-") || it.missedDose.equals("----") || it.missedDose.equals("-----")){
                        binding.doseLyout.isVisible = false
                    }else{
