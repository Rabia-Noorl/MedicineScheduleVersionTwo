package com.example.medicineschedule.adaptors
...
class NotesRVAdapter(val context: Context,val noteClickInterface: NoteClickInterface,
val noteClickDeleteInterface: NoteClickDeleteInterface):RecyclerView.Adapter<NotesRVAdapter.ViewHolder>() {
